...
router.post('/register', (req, res) => {
	...
	console.log(`Register called with ${JSON.stringify(req.body)}`);
...
router.post('/login', (req, res) => {
	console.log(`login called with ${JSON.stringify(req.body)}`);
	...
	return req.send(response('Missing parameters'));
});
...
router.get('/dump', (req, res) => {
	db.dump().then(data => res.send({data}))
})
