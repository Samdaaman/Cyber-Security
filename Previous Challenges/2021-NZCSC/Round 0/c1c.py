...
def main():
    ...
    with open('rockyou.txt', 'r') as fh:
        ...
        password = '167262192369'
        m = hashlib.md5()
        m.update(password.encode())
        key = m.digest()[:8]
        cipher = b64decode('1eINeaNw0zyPQlbz2421R8/qqdh5CGTc')
        # cipher = b64decode('V+QQEMfkRgUXVy8d8aI93UfMI9auuIGkco2Zm7Gs2bc+pFS1hgR7+ppKqHgyn3XeLGpUggbuAMU=')
